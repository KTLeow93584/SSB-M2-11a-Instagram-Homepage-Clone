...
export function SidebarButtonBI({ header, biIcon, isHeader = false, isTransparent = false }) {
    return (
        <Button
...
export function SidebarButtonFA({ header, faIcon, isHeader, isTransparent }) {
    return (
        <Button
            className={`d-flex align-items-center w-100 text-sm-center text-md-start ${isTransparent ? "side-dashboard-button-full-transparent" : "side-dashboard-button"}`}
            style={{ marginBottom: `${isHeader ? "0" : "7"}px` }}>
...
export function SidebarButtonImage({ header, src, isHeader = false, isTransparent = false }) {
    return (
        <Button
            className={`d-flex align-items-center w-100 text-sm-center text-md-start ${isTransparent ? "side-dashboard-button-full-transparent" : "side-dashboard-button"}`}
            style={{ marginBottom: `${isHeader ? "0" : "7"}px` }}>
